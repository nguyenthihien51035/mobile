...
public class ContainerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (searchKeyword != null && !searchKeyword.isEmpty()) {
            ...
            loadProductsBySearch(searchKeyword, 0);
        } else if (categoryId != -1) {
            // Filter theo category bình thường
            loadProductsByCategory(categoryId, 0);
        } else {
            Log.e("ContainerActivity", "CATEGORY_ID = -1 và không có keyword");
    ...
    public void onSortApplied(String sortBy, String sortDirection) {
        ...
        if (currentSearchKeyword != null) {
            loadProductsBySearch(currentSearchKeyword, 0);
        } else {
            loadProductsByCategory(categoryId, 0);
        }
    }
    ...
    private void loadProductsBySearch(String keyword, int pageNumber) {
        Log.i("ProductLoad", "Đang tìm kiếm: " + keyword + " - Trang " + (pageNumber + 1));

        repository.getFilteredProducts(
                categoryId,   // categoryId = -1 để tìm tất cả
                ...
                new ProductRepository.ProductPageCallback() {
                    ...
                    public void onSuccess(ProductPageResponse response) {
                        ...
                        Log.i("ProductLoad", "Tìm thấy " + allProducts.size() + " sản phẩm cho: " + keyword);
                    ...
                    public void onError(String errorMessage) {
                        Log.e("ProductLoad", "Lỗi tìm kiếm: " + errorMessage);
                        runOnUiThread(() ->
